...
<div class="modal-bg" id="rgModal">
  <div class="modal-card" style="max-width:640px">
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group"><label class="form-label">Depot Role</label><select class="form-select" id="rgRole"><option value="">Member (no position)</option><option>Depot Commander</option><option>Deputy Commander</option><option>Secretary</option><option>Publicity</option><option>Committee Member</option></select></div>
        <div class="form-group"></div>
      </div>
